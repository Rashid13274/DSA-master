/* Find out Number of  Occurance in sorted array.
arr = [1,2,4,5,10,10,12]

Number of Occurance = index of second occurance - index of first occurance + 1
*/
...
const totalOccurance = second - first + 1;
